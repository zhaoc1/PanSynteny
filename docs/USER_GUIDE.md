...
```bash
PY=/pollard/home/czhao/miniforge3/envs/pansynteny/bin/python
RSC=/pollard/home/czhao/miniforge3/envs/pansynteny/bin/Rscript
...
```bash
export LD_LIBRARY_PATH=/pollard/home/czhao/miniforge3/envs/pansynteny/lib:$LD_LIBRARY_PATH
```
...
- `step6_blocks/rep_heatmap.pdf` - block x genome presence/absence.
...
- **Read a step in detail:** [STEPS.md](STEPS.md) section STEP N has the full input / output / logic.
